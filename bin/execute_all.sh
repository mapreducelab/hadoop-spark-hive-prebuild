...
ssh $user@${host} "source .bash_profile; hadoop fs -mkdir -p /apps/tez; hadoop fs -put apache-tez-0.9.0-bin.tar.gz   hdfs://0.0.0.0/apps/tez/apache-tez-0.9.0-bin.tar.gz"